...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_login(self): 
        ...
        pyautogui.write(r"Newfolder.rar") #path of File
        pyautogui.press('enter')
        time.sleep(5)
        browser.find_element(By.XPATH, '/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[4]/div/div[2]/textarea').send_keys("saya seorang kepala sekolah")   
        time.sleep(5)
