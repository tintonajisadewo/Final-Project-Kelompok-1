...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_login(self): 
        ...
        #InputFileUpload
        browser.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[2]/input").send_keys("SQA")
        time.sleep(5)
        browser.find_element(By.CSS_SELECTOR,'#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div:nth-child(2) > div > div:nth-child(2) > textarea').send_keys("")
        time.sleep(5)
        #uploadBerkas
